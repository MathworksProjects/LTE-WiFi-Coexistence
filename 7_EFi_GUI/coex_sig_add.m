function [lte_wifi_waveform, nWiFiFrames,offset,overlap_reshape,lte_rxWaveform_awgn] = coex_sig_add(lWiFi, lPadding, lte_rxWaveform_awgn, wifi_rxWaveform_awgn, nWiFiFrames, fsLTE, fsWiFi)
